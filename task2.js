...
const title1 = library.books.at(0).title;
const author1 = library.books.at(0).author;
const yearOfPublication1 = library.books.at(0).yearOfPublication;
const title2 = library.books.at(1).title;
const author2 = library.books.at(1).author;
const yearOfPublication2 = library.books.at(1).yearOfPublication;
const title3 = library.books.at(2).title;
const author3 = library.books.at(2).author;
const yearOfPublication3 = library.books.at(2).yearOfPublication;
